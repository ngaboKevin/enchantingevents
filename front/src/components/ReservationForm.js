...
const ReservationForm = ({ selectedCategory }) => {
    ...
    return (
        <form className="reservation-form" onSubmit={handleSubmit}>
            <div className="form-group">
                ...
                <div className="form-group">
        <label htmlFor="accommodationCategory">Accommodation Category</label>
        <select
        ...
        >
          ...
          <option value="Airbnb">Airbnb</option>
                ...
                <div className="form-row">
                    <div className="input-container">
                        <input type="text" name="budget_range_min" value={formData.budget_range_min} onChange={handleChange} placeholder="enter your minimum budget" required />
                    </div>
                </div>
                <div className="form-row">
                    <div className="input-container">
                        <input type="text" name="budget_range_max" value={formData.budget_range_max} onChange={handleChange} placeholder="enter your maximum budget" required />
                    </div>
                </div>
                ...
                <div className="input-container">
                    ...
                    <textarea name="special_request" value={formData.special_request} onChange={handleChange} placeholder="Description"></textarea>
                </div>
